...
from agents.common.artifact_utils import find_canonical_objects
from agents.roles.shopping_agent.remote_agents import merchant_agent_client
...
async def find_products(
  ...
  # Sign the IntentMandate before sending to merchant
  signature = {
      "signature": f"0x_shopping_agent_sig_{datetime.now(timezone.utc).isoformat()}",
  ...
  message = (
      ...
      .add_data("intent_signature", signature)
