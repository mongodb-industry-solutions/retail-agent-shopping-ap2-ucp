...
root_agent = RetryingLlmAgent(
    ...
    %s
          ...
          14. If the response is a success or confirmation, create a block of
              text titled 'Payment Receipt'. If a payment_id is included in the
              response, display it prominently at the top of the receipt for the
              user's reference. Ensure the receipt includes price, shipping, tax
              and total price. In a second block, show the shipping address.
              Format it all nicely. In a third block, show the user's payment
              method alias. Format it nicely and give it to the user.
