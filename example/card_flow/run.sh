...
if [ -f "$SCRIPT_DIR/setup_ledger_env.sh" ]; then
  echo "Loading Mandate Ledger Service configuration..."
  source "$SCRIPT_DIR/setup_ledger_env.sh"
fi
