export const introSlides = [
  ...
  },
  {
    ...
    description:
      "<p>Our <em>advanced algorithms</em> learn your preferences to show you products you'll love.</p><p><a href='#' class='text-blue-500 underline'>Never miss out</a> on perfect matches again with our intelligent matching system.</p>",
  ...
  },
  {
    ...
    description:
      "<p>Shop with confidence using our <strong>secure, fast payment system</strong>.</p><p>Multiple payment options with <span class='font-semibold text-green-600'>enterprise-grade security</span> protect your transactions.</p>",
