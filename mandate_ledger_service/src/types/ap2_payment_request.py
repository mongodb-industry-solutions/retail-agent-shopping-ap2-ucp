...
DUPLICATION NOTE: This file is a copy of src/ap2/types/payment_request.py
from the parent AP2 project. See src/types/__init__.py for details.
"""

from typing import Any, Dict, Optional

from src.types.ap2_contact import ContactAddress
