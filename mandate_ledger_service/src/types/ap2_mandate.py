...
DUPLICATION NOTE: This file is a copy of src/ap2/types/mandate.py
...
from src.types.ap2_payment_request import PaymentItem
from src.types.ap2_payment_request import PaymentRequest
from src.types.ap2_payment_request import PaymentResponse
