...
Open http://localhost:8000 and you should see the following UI.
...
│
├── assistant/                     # Assistant service integration assets
│   └── config/                    # Assistant service configuration
│
...
├── cicd-kanopy/                   # CI/CD and deployment notes
├── environment/                   # Environment-specific YAML configs
