...
3. The backend API will be accessible at http://localhost:8005

**Note**: If port 8005 is already in use (e.g., by Docker containers), either stop the containers with `make clean` or use a different port like `--port 8001`.
